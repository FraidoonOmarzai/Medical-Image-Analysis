...
class S3Operation:
    ...
    Methods:
        sync_folder_to_s3: Syncs a local folder to a specified folder within a S3 bucket.
        sync_folder_from_s3: Syncs a specified folder within a S3 bucket to a local folder.
    """
    ...
    def sync_folder_to_s3(self,
        ...
        """Syncs a specified folder within a S3 bucket to a local folder.
